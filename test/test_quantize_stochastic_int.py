...
def test_quantize_stochastic_int():
    ...
    with tf.Session('') as sess:
        ...
        const1_q = waveflow.wavecomp_ops_module.wave_quantize_int(tensor_const1, const1_bp, use_stochastic_round=True)
