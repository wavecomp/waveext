...
data_url = 'http://www.statmt.org/europarl/v7/fr-en.tgz'
data_path = './data/fr-en.tgz'
dst_folder = './data'
...
dataset = data_processing.DataCreator(data_path=data_path, num_samples=num_samples, max_sample_len=max_sample_len)
dataset.read_data()
dataset.print_summary()
encoder_input_data, decoder_input_data, decoder_target_data = dataset.onehot_encode()

# Define an input sequence and process it.
encoder_inputs = Input(shape=(None, dataset.get_num_encode_tokens()))
...
decoder_inputs = Input(shape=(None, dataset.get_num_decode_tokens()))
...
decoder_dense = Dense(dataset.get_num_decode_tokens(), activation='softmax')
