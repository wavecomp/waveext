...
import waveflow
def train(src, tgt, src_trans, tgt_trans, src_vocab, tgt_vocab, src_emb=None, tgt_emb=None):
  ...
  i = 0
  with tf.train.MonitoredTrainingSession(checkpoint_dir="model", config=config) as sess:
