...
tf.app.flags.DEFINE_string('arith', 'tf', '''Arithmetic type''')
tf.app.flags.DEFINE_boolean('tensorboard', True, '''Generate Tensorboard data''')
tf.app.flags.DEFINE_boolean('trace', False, '''Generate execution trace''')
