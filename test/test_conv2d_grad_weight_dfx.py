...
# test_conv2d_grad_weight_dfx.py
#
...
def test_conv2d_grad_weight_dfx():
    ...
    for i in range(total_iters):
        ...
        with tf.Session('', config=config) as sess:
            ...
            z_op = waveflow.wavecomp_ops_module.wave_conv2d_dfx_gradient_weight(
                c2d_in,
                wgt_shape,
                gradient_same,
                strides=[1, 1, 1, 1],
