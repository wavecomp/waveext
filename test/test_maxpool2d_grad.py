...
def test_maxpool2d():
    ...
    for i in range(iterations):
        ...
        # N H W C
        max_in_tmp = tf.get_variable("a", [t_n, t_h, t_w, t_c], dtype=tf.float32, initializer=tf.truncated_normal_initializer(stddev=0.1))
        max_in = waveflow.wavecomp_ops_module.wave_quantize_dfx(max_in_tmp, [16, 14])
