...
class WaveMulDfxOp : public WaveBinDfxOp {
  public:

  explicit WaveMulDfxOp(OpKernelConstruction* ctx) : WaveBinDfxOp(ctx) {
...
bool WaveMulDfxOp::m_show_banner = true;

REGISTER_KERNEL_BUILDER(Name("WaveMulDfx").Device(DEVICE_CPU), WaveMulDfxOp);